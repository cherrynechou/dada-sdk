 ...
 * Time: 16:13
 */
namespace CherryneChou\EasyDada\Kernel\Support;

use ArrayAccess;
use ArrayIterator;
use Countable;
use CherryneChou\EasyDada\Kernel\Contracts\Arrayable;
...
class Collection implements ArrayAccess, Countable, IteratorAggregate, JsonSerializable, Serializable, Arrayable
{
     ...
     * @param array $keys
     *
     * @return \CherryneChou\EasyDada\Kernel\Support\Collection
     */
